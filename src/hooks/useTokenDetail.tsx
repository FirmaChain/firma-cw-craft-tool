...
const useTokenDetail = () => {
  ...
  const getTokenDetail = useCallback(async (contractAddress: string, address: string) => {
    const resultData = {
      label: "",
      decimals: "",
      tokenName: "",
  ...
  const getWalletSearch = useCallback(async (contractAddress: string, address: string) => {
    const resultData = {
      balanceAmount: "",
      allAllowances: [],
      allSpenders: [],
