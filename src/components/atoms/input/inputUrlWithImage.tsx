  ...
  return (
    <Stack sx={{ ...sx, width: '100%' }}>
      <FormControl variant='outlined' sx={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        <Stack sx={{ width: '90px', height: '90px', backgroundColor: '#262626', borderRadius: '153.409px', border: '1px solid #383838', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
          {validTokenLogoUrl === "" ? 
            <IconBackground>
