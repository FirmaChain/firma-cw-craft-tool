const Amount = (props: any) => {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="wallet-fill">
        <g id="Dollar Coin 1">
          <path d="M11.4789 2.01338C6.37084 2.2756 2.2756 6.37084 2.01338 11.4789C1.70995 17.3899 6.61011 22.2901 12.5211 21.9866C17.6292 21.7244 21.7244 17.6292 21.9866 12.5211C22.2901 6.61011 17.3899 1.70995 11.4789 2.01338ZM13.097 17.0919V18.6133H11.2885V17.1659C10.2033 17.0551 8.90274 16.7049 8.00306 15.8642L9.21706 14.3743C10.1593 14.9937 10.9844 15.273 11.8601 15.3097C13.121 15.3629 13.6887 14.8605 13.6519 14.1829C13.5633 12.5483 8.47939 12.6049 8.47939 9.73489C8.47939 8.17625 9.54241 7.09571 11.2884 6.79773V5.39228H13.0969V6.76359C14.27 6.91604 15.131 7.41224 15.847 8.06368L14.4835 9.40394C13.8095 8.87817 13.1765 8.56827 12.4026 8.5484C11.2623 8.51912 10.8852 9.05563 10.8936 9.59583C10.9171 11.1124 15.9821 11.0088 15.9821 14.0489C15.9821 15.5736 15 16.7461 13.0969 17.0918L13.097 17.0919Z" fill="#02E191" />
          <path d="M11.4789 2.01338C6.37084 2.2756 2.2756 6.37084 2.01338 11.4789C1.70995 17.3899 6.61011 22.2901 12.5211 21.9866C17.6292 21.7244 21.7244 17.6292 21.9866 12.5211C22.2901 6.61011 17.3899 1.70995 11.4789 2.01338ZM13.097 17.0919V18.6133H11.2885V17.1659C10.2033 17.0551 8.90274 16.7049 8.00306 15.8642L9.21706 14.3743C10.1593 14.9937 10.9844 15.273 11.8601 15.3097C13.121 15.3629 13.6887 14.8605 13.6519 14.1829C13.5633 12.5483 8.47939 12.6049 8.47939 9.73489C8.47939 8.17625 9.54241 7.09571 11.2884 6.79773V5.39228H13.0969V6.76359C14.27 6.91604 15.131 7.41224 15.847 8.06368L14.4835 9.40394C13.8095 8.87817 13.1765 8.56827 12.4026 8.5484C11.2623 8.51912 10.8852 9.05563 10.8936 9.59583C10.9171 11.1124 15.9821 11.0088 15.9821 14.0489C15.9821 15.5736 15 16.7461 13.0969 17.0918L13.097 17.0919Z" fill="black" fillOpacity="0.3" />
        </g>
      </g>
    </svg>
  )
...
const CoinStack1 = (props: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M5 8C5 5.79086 6.79086 4 9 4H15C17.2091 4 19 5.79086 19 8V16.1552C19 18.0007 17.7374 19.6066 15.944 20.0422L12.944 20.7707C12.3237 20.9214 11.6763 20.9214 11.056 20.7707L8.05601 20.0422C6.26262 19.6066 5 18.0007 5 16.1552V8Z" fill="#02E191" />
      <path d="M5 8C5 5.79086 6.79086 4 9 4H15C17.2091 4 19 5.79086 19 8V16.1552C19 18.0007 17.7374 19.6066 15.944 20.0422L12.944 20.7707C12.3237 20.9214 11.6763 20.9214 11.056 20.7707L8.05601 20.0422C6.26262 19.6066 5 18.0007 5 16.1552V8Z" fill="black" fillOpacity="0.2" />
      <path d="M12 8.4C15.866 8.4 19 7.19117 19 5.7C19 4.20883 15.866 3 12 3C8.13401 3 5 4.20883 5 5.7C5 7.19117 8.13401 8.4 12 8.4Z" fill="#02E191" />
      <path d="M12 8.4C15.866 8.4 19 7.19117 19 5.7C19 4.20883 15.866 3 12 3C8.13401 3 5 4.20883 5 5.7C5 7.19117 8.13401 8.4 12 8.4Z" fill="black" fillOpacity="0.2" />
      <path d="M19 5.7C19 7.19117 15.866 8.4 12 8.4C8.13401 8.4 5 7.19117 5 5.7M19 5.7C19 4.20883 15.866 3 12 3C8.13401 3 5 4.20883 5 5.7M19 5.7V18.3C19 19.7912 15.866 21 12 21C8.13401 21 5 19.7912 5 18.3V5.7M19 9.89994C19 11.3911 15.866 12.5999 12 12.5999C8.13401 12.5999 5 11.3911 5 9.89994M19 14.097C19 15.5882 15.866 16.797 12 16.797C8.13401 16.797 5 15.5882 5 14.097" stroke="#1E1E1E" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
};
  ...
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="coins-stacked-02">
        <g id="Icon">
          <path d="M7.05 6.44444C10.3913 6.44444 13.1 5.44952 13.1 4.22222C13.1 2.99492 10.3913 2 7.05 2C3.70868 2 1 2.99492 1 4.22222C1 5.44952 3.70868 6.44444 7.05 6.44444Z" fill="#807E7E" />
          <path d="M16.95 13.1111C20.2913 13.1111 23 12.1162 23 10.8889C23 9.66159 20.2913 8.66667 16.95 8.66667C13.6087 8.66667 10.9 9.66159 10.9 10.8889C10.9 12.1162 13.6087 13.1111 16.95 13.1111Z" fill="#807E7E" />
          <path d="M10.9 10.8889C10.9 9.66159 13.6087 8.66667 16.95 8.66667C20.2913 8.66667 23 9.66159 23 10.8889V19.7778C23 21.0051 20.2913 22 16.95 22C13.6087 22 10.9 21.0051 10.9 19.7778V10.8889Z" fill="#807E7E" />
          <path d="M7.05 2C3.70868 2 1 2.99492 1 4.22222V17.5556C1 18.7829 3.70868 19.7778 7.05 19.7778C8.51259 19.7778 9.85397 19.5871 10.9 19.2698V10.8889C10.9 10.1988 11.7563 9.5822 13.1 9.17461V4.22222C13.1 2.99492 10.3913 2 7.05 2Z" fill="#807E7E" />
          <path d="M13.1 4.22222C13.1 5.44952 10.3913 6.44444 7.05 6.44444C3.70868 6.44444 1 5.44952 1 4.22222M13.1 4.22222C13.1 2.99492 10.3913 2 7.05 2C3.70868 2 1 2.99492 1 4.22222M13.1 4.22222V9.17461C11.7563 9.5822 10.9 10.1988 10.9 10.8889M1 4.22222V17.5556C1 18.7829 3.70868 19.7778 7.05 19.7778C8.51259 19.7778 9.85397 19.5871 10.9 19.2698V10.8889M1 8.66667C1 9.89397 3.70868 10.8889 7.05 10.8889C8.51259 10.8889 9.85397 10.6983 10.9 10.3809M1 13.1111C1 14.3384 3.70868 15.3333 7.05 15.3333C8.51259 15.3333 9.85397 15.1427 10.9 14.8254M23 10.8889C23 12.1162 20.2913 13.1111 16.95 13.1111C13.6087 13.1111 10.9 12.1162 10.9 10.8889M23 10.8889C23 9.66159 20.2913 8.66667 16.95 8.66667C13.6087 8.66667 10.9 9.66159 10.9 10.8889M23 10.8889V19.7778C23 21.0051 20.2913 22 16.95 22C13.6087 22 10.9 21.0051 10.9 19.7778V10.8889M23 15.3333C23 16.5606 20.2913 17.5556 16.95 17.5556C13.6087 17.5556 10.9 16.5606 10.9 15.3333" stroke="#1E1E1E" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </g>
    </svg>
  )
      ...
      <g id="Frame 2243">
        <g id="Group 427320625">
          <g id="Group 427320628">
            <path id="Path" d="M12.788 21.9235L12.3257 21.6572V16.9979L14.6684 15.6581L12.788 14.582L10.4609 15.914V22.741L12.788 24.0678L18.7845 20.649L16.9615 19.5391L12.788 21.9235Z" fill="white" />
            <path id="Path_2" d="M12.7887 6L3 11.5864V22.7776L4.86215 23.838V12.6703L12.7887 8.14421L16.3589 10.1892L16.7637 8.26696L12.7887 6Z" fill="white" />
            <path id="Path_3" d="M20.7149 12.6814V21.6944L12.7883 26.2231L8.58871 23.8203V14.8412L12.7883 12.4411L16.988 14.8334L18.8501 13.7731V13.7574L12.7883 10.2969L6.72656 13.7574V24.9068L12.7883 28.3647L22.577 22.7782V11.6053L20.7149 12.6814Z" fill="white" />
            <path id="Path_4" d="M30.8574 12.0508H38.6586V13.8555H32.986V16.9086H37.8881V18.7133H32.986V23.0513H30.8574V12.0508Z" fill="white" />
            <path id="Path_5" d="M39.9922 12.0508H42.139V23.0513H39.9922V12.0508Z" fill="white" />
            <path id="Shape" d="M52.9052 19.4001V23.0513H50.7688V19.8885L49.8234 18.8386H46.3942V23.0513H44.2578V12.0508H51.2076L52.8634 13.7484V17.06L51.7952 18.1439L52.9052 19.4027V19.4001ZM46.3968 17.0731H50.189L50.7349 16.5273V14.3909L50.189 13.8372H46.3968V17.0731Z" fill="white" />
            <path id="Path_6" d="M54.877 12.0508H56.8566L60.1265 19.152L63.4407 12.0508H65.4204V23.0513H63.365V16.3549L60.8813 21.5104H59.4892L57.0055 16.3549V23.0513H54.877V12.0508Z" fill="white" />
            <path id="Shape_2" d="M70.5539 12.0508H72.4997L76.5243 23.0513H74.3958L73.5026 20.6172H69.5928L68.6996 23.0513H66.5293L70.5539 12.0508ZM72.9881 18.8543L71.5229 14.7147L70.1073 18.8543H72.9907H72.9881Z" fill="white" />
            <path id="Vector" d="M123.751 13.8617H120.453V12.0469H129.196V13.8617H125.898V23.0936H123.751V13.8617Z" fill="white" />
            <path id="Vector_2" d="M112.15 12.0469H119.978V13.8617H114.297V16.9232H119.22V18.738H114.297V23.0936H112.15V12.0469Z" fill="white" />
            <path id="Vector_3" d="M105.04 12.0469H106.997L111.037 23.0936H108.859L107.959 20.6475H104.077L103.178 23.0936H101L105.04 12.0469ZM107.486 18.88L106.018 14.6823H105.987L104.567 18.88H107.486Z" fill="white" />
            <path id="Vector_4" d="M99.9784 19.4324V23.0936H97.8322V19.9216L96.8853 18.8643H93.445V23.0936H91.2988V12.0469H98.2267L99.9153 13.7512V17.0968L98.8421 18.1857L99.9784 19.4324ZM93.445 17.0968H97.2483L97.8006 16.5445V14.3982L97.2483 13.8459H93.445V17.0968Z" fill="white" />
            <path id="Vector_5" d="M80.8008 21.2788V13.8617L82.6156 12.0469H88.0127L89.7959 13.8301V15.5187H87.6497V14.6192L86.908 13.8775H83.7518L82.947 14.6823V20.4581L83.7518 21.263H86.908L87.6497 20.5213V19.6218H89.7959V21.3103L88.0127 23.0936H82.6156L80.8008 21.2788Z" fill="white" />
          </g>
        </g>
      </g>
    </svg>
...
const FirmaChain = (props: any) => {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="symbol_white 1">
        <g id="&#234;&#183;&#184;&#235;&#163;&#185; 27393">
          <path id="&#237;&#140;&#168;&#236;&#138;&#164; 2149" d="M12.0199 16.3918L11.5946 16.1489V11.8746L13.7454 10.6449L12.0214 9.65808L9.88721 10.8818V17.1427L12.0199 18.3572L17.5187 15.2222L15.8477 14.2038L12.0199 16.3918Z" fill="#707070" />
          <path id="&#237;&#140;&#168;&#236;&#138;&#164; 2150" d="M12.021 1.78601L3.0437 6.90952V17.1721L4.75253 18.1437V7.90374L12.021 3.75035L15.2936 5.62679L15.6645 3.86605L12.021 1.78601Z" fill="#707070" />
          <path id="&#237;&#140;&#168;&#236;&#138;&#164; 2151" d="M19.2911 7.90997V16.176L12.0226 20.3294L8.17183 18.127V9.89136L12.0226 7.69006L15.873 9.88357L17.5819 8.91198V8.89677L12.0226 5.72424L6.46338 8.89677V19.1215L12.023 22.2944L20.9999 17.1706V6.92317L19.2911 7.90997Z" fill="#707070" />
        </g>
      </g>
    </svg>
  )
...
const picture = (props: any) => {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="Image 2">
        <g id="Fill 1">
          <path d="M34.6669 22.504V24.8099C34.6669 25.1925 34.6502 25.5785 34.6168 25.9611C34.1492 31.2263 30.4918 34.6667 25.2146 34.6667H10.7858C8.11375 34.6667 5.85924 33.7995 4.23934 32.2271C3.60474 31.644 3.07033 30.9589 2.65283 30.1736C3.20393 29.5035 3.82184 28.77 4.42304 28.0348C5.44174 26.815 6.42705 25.6102 7.04495 24.8266C7.96345 23.6903 10.385 20.6994 13.7417 22.1029C14.4264 22.387 15.0276 22.788 15.5787 23.1389C16.9314 24.0412 17.4992 24.3086 18.4511 23.7906C19.5032 23.2225 20.1879 22.1029 20.906 20.9333C21.2901 20.3134 21.6742 19.7135 22.0917 19.1621C23.912 16.7894 26.7176 16.1544 29.0556 17.558C30.2246 18.2598 31.2266 19.1454 32.1618 20.046C32.3622 20.2465 32.5627 20.432 32.7464 20.6158C32.9969 20.8665 33.8319 21.7019 34.6669 22.504Z" fill="#444444" />
          <path d="M34.6669 22.504V24.8099C34.6669 25.1925 34.6502 25.5785 34.6168 25.9611C34.1492 31.2263 30.4918 34.6667 25.2146 34.6667H10.7858C8.11375 34.6667 5.85924 33.7995 4.23934 32.2271C3.60474 31.644 3.07033 30.9589 2.65283 30.1736C3.20393 29.5035 3.82184 28.77 4.42304 28.0348C5.44174 26.815 6.42705 25.6102 7.04495 24.8266C7.96345 23.6903 10.385 20.6994 13.7417 22.1029C14.4264 22.387 15.0276 22.788 15.5787 23.1389C16.9314 24.0412 17.4992 24.3086 18.4511 23.7906C19.5032 23.2225 20.1879 22.1029 20.906 20.9333C21.2901 20.3134 21.6742 19.7135 22.0917 19.1621C23.912 16.7894 26.7176 16.1544 29.0556 17.558C30.2246 18.2598 31.2266 19.1454 32.1618 20.046C32.3622 20.2465 32.5627 20.432 32.7464 20.6158C32.9969 20.8665 33.8319 21.7019 34.6669 22.504" stroke="#444444" />
        </g>
        <g id="Fill 3">
          <path d="M25.2313 1.33337H10.7857C5.12441 1.33337 1.3335 5.29349 1.3335 11.1902V24.81C1.3335 26.8636 1.8011 28.6866 2.6528 30.1737C3.2039 29.5037 3.82181 28.7701 4.42301 28.0333C5.44171 26.8151 6.42702 25.6104 7.04492 24.8267C7.96342 23.6905 10.3849 20.6995 13.7416 22.1031C14.4263 22.3872 15.0276 22.7882 15.5787 23.1391C16.9314 24.0414 17.4992 24.3087 18.4511 23.7891C19.5032 23.2226 20.1879 22.1031 20.906 20.9318C21.2901 20.3135 21.6742 19.7137 22.0917 19.1623C23.912 16.7895 26.7176 16.1546 29.0556 17.5582C30.2246 18.26 31.2266 19.1456 32.1618 20.0462C32.3622 20.2467 32.5626 20.4322 32.7463 20.616C32.9968 20.8649 33.8318 21.7004 34.6668 22.5041V11.1902C34.6668 5.29349 30.8759 1.33337 25.2313 1.33337Z" fill="#222222" />
          <path d="M25.2313 1.33337H10.7857C5.12441 1.33337 1.3335 5.29349 1.3335 11.1902V24.81C1.3335 26.8636 1.8011 28.6866 2.6528 30.1737C3.2039 29.5037 3.82181 28.7701 4.42301 28.0333C5.44171 26.8151 6.42702 25.6104 7.04492 24.8267C7.96342 23.6905 10.3849 20.6995 13.7416 22.1031C14.4263 22.3872 15.0276 22.7882 15.5787 23.1391C16.9314 24.0414 17.4992 24.3087 18.4511 23.7891C19.5032 23.2226 20.1879 22.1031 20.906 20.9318C21.2901 20.3135 21.6742 19.7137 22.0917 19.1623C23.912 16.7895 26.7176 16.1546 29.0556 17.5582C30.2246 18.26 31.2266 19.1456 32.1618 20.0462C32.3622 20.2467 32.5626 20.4322 32.7463 20.616C32.9968 20.8649 33.8318 21.7004 34.6668 22.5041V11.1902C34.6668 5.29349 30.8759 1.33337 25.2313 1.33337" stroke="#444444" />
        </g>
        <g id="Fill 5">
          <path d="M17.091 12.6612C17.091 15.0088 15.1354 16.9638 12.789 16.9638C10.4443 16.9638 8.48877 15.0088 8.48877 12.6612C8.48877 10.3152 10.4443 8.35852 12.789 8.35852C15.1354 8.35852 17.091 10.3152 17.091 12.6612Z" fill="#444444" />
          <path d="M17.091 12.6612C17.091 15.0088 15.1354 16.9638 12.789 16.9638C10.4443 16.9638 8.48877 15.0088 8.48877 12.6612C8.48877 10.3152 10.4443 8.35852 12.789 8.35852C15.1354 8.35852 17.091 10.3152 17.091 12.6612" stroke="#444444" />
        </g>
      </g>
    </svg>
  )
...
const medium = (props: any) => {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
const minusCircle = (props: any) => {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="minus-circle">
        <g id="Icon">
          <path d="M16 28C22.6274 28 28 22.6274 28 16C28 9.37258 22.6274 4 16 4C9.37258 4 4 9.37258 4 16C4 22.6274 9.37258 28 16 28Z" fill="#707070" />
          <path d="M11.2 16H20.8M28 16C28 22.6274 22.6274 28 16 28C9.37258 28 4 22.6274 4 16C4 9.37258 9.37258 4 16 4C22.6274 4 28 9.37258 28 16Z" stroke="#1E1E1E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </g>
    </svg>
  )
  ...
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="percent-02">
        ...
        <g id="Icon_2">
          <path d="M6 9C7.10457 9 8 8.10457 8 7C8 5.89543 7.10457 5 6 5C4.89543 5 4 5.89543 4 7C4 8.10457 4.89543 9 6 9Z" fill="#807E7E" />
          <path d="M18 20C19.1046 20 20 19.1046 20 18C20 16.8954 19.1046 16 18 16C16.8954 16 16 16.8954 16 18C16 19.1046 16.8954 20 18 20Z" fill="#807E7E" />
          <path d="M6 9C7.10457 9 8 8.10457 8 7C8 5.89543 7.10457 5 6 5C4.89543 5 4 5.89543 4 7C4 8.10457 4.89543 9 6 9Z" stroke="#807E7E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M18 20C19.1046 20 20 19.1046 20 18C20 16.8954 19.1046 16 18 16C16.8954 16 16 16.8954 16 18C16 19.1046 16.8954 20 18 20Z" stroke="#807E7E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
        </g>
      </g>
    </svg>
  )
    ...
    <svg width={props.width} height={props.height} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="coins-01">
        <path
          ...
          strokeLinejoin="round"
        />
        <path id="Icon_2" d="M16 20C18.2091 20 20 18.2091 20 16C20 13.7909 18.2091 12 16 12C13.7909 12 12 13.7909 12 16C12 18.2091 13.7909 20 16 20Z" fill="#807E7E" stroke="#313131" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  )
};
...
const tag = (props: any) => {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="tag-01">
        <path id="Icon" d="M2.93726 11.9373C2.59135 11.5914 2.4184 11.4184 2.29472 11.2166C2.18506 11.0376 2.10425 10.8425 2.05526 10.6385C2 10.4083 2 10.1637 2 9.67451L2 5.2C2 4.07989 2 3.51984 2.21799 3.09202C2.40973 2.7157 2.7157 2.40973 3.09202 2.21799C3.51984 2 4.0799 2 5.2 2L9.67452 2C10.1637 2 10.4083 2 10.6385 2.05526C10.8425 2.10425 11.0376 2.18506 11.2166 2.29472C11.4184 2.4184 11.5914 2.59135 11.9373 2.93726L19.6059 10.6059C20.7939 11.7939 21.388 12.388 21.6105 13.0729C21.8063 13.6755 21.8063 14.3245 21.6105 14.927C21.388 15.612 20.7939 16.2061 19.6059 17.3941L17.3941 19.6059C16.2061 20.7939 15.612 21.388 14.927 21.6105C14.3245 21.8063 13.6755 21.8063 13.0729 21.6105C12.388 21.388 11.7939 20.7939 10.6059 19.6059L2.93726 11.9373Z" fill="#707070" />
        <path id="Icon_2" d="M8 8H8.01M8.5 8C8.5 8.27614 8.27614 8.5 8 8.5C7.72386 8.5 7.5 8.27614 7.5 8C7.5 7.72386 7.72386 7.5 8 7.5C8.27614 7.5 8.5 7.72386 8.5 8Z" stroke="#1E1E1E" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  )
};
...
const telegram = (props: any) => {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" xlinkHref="http://www.w3.org/1999/xlink">
...
const RightArrow = (props: any) => {
  return (
    <svg width={props.width} height={props.height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="chevron-down">
        <path id="Icon" d="M9 4L17 12L9 20" stroke={props.isCheck ? "#FFFFFF" : "#707070"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  )
};
...
const LeftArrow = (props: any) => {
  return (
    <svg width={props.width || "24"} height={props.height || "24"} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="chevron-down">
        <path id="Icon" d="M15 4L7 12L15 20" stroke={props.isCheck ? "#FFFFFF" : "#707070"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </g>
    </svg>
  )
};
...
const ExternalLink = (props: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.width} height={props.height} viewBox="0 0 20 20" fill="none">
      <path d="M16.25 7.91667L16.25 3.75M16.25 3.75H12.0833M16.25 3.75L10.6944 9.30556M8.61111 5.13889H7.08333C5.91656 5.13889 5.33317 5.13889 4.88752 5.36596C4.49552 5.56569 4.17681 5.8844 3.97707 6.27641C3.75 6.72206 3.75 7.30545 3.75 8.47222V12.9167C3.75 14.0834 3.75 14.6668 3.97707 15.1125C4.17681 15.5045 4.49552 15.8232 4.88752 16.0229C5.33317 16.25 5.91656 16.25 7.08333 16.25H11.5278C12.6946 16.25 13.2779 16.25 13.7236 16.0229C14.1156 15.8232 14.4343 15.5045 14.634 15.1125C14.8611 14.6668 14.8611 14.0834 14.8611 12.9167V11.3889" stroke="#DCDCDC" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
};
...
const LeftDoubleArrow = (props: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.width} height={props.height} viewBox="0 0 20 20" fill="none">
      <path d="M14.332 14L10.332 10L14.332 6.00002" stroke={props.isCheck ? "#FFFFFF" : "#707070"} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10.3301 14L6.33008 10L10.3301 6.00002" stroke={props.isCheck ? "#FFFFFF" : "#707070"} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
};
...
const RightDoubleArrow = (props: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.width} height={props.height} viewBox="0 0 20 20" fill="none">
      <path d="M6.33594 6L10.3359 9.99999L6.33594 14" stroke={props.isCheck ? "#FFFFFF" : "#707070"} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M10.3359 6L14.3359 9.99999L10.3359 14" stroke={props.isCheck ? "#FFFFFF" : "#707070"} strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
};
...
const XCircle = (props: any) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={props.width} height={props.height} viewBox="0 0 32 32" fill="none">
      <path d="M16.0013 29.3327C23.3651 29.3327 29.3346 23.3631 29.3346 15.9993C29.3346 8.63555 23.3651 2.66602 16.0013 2.66602C8.63751 2.66602 2.66797 8.63555 2.66797 15.9993C2.66797 23.3631 8.63751 29.3327 16.0013 29.3327Z" fill="#707070" />
      <path
...
const Icons = {
  Amount, CoinStack1, CoinStack2, Coins, Edit, FirmaCraft, FirmaChain, picture, info, link,
  minusCircle, percent, plusCircle, preview, search, setting, twitter, telegram,
  valid, medium, wallet, tag, RightArrow, LeftArrow, Dot, Copy, ExternalLink, LeftDoubleArrow, RightDoubleArrow,
  Success, Failed, Add, Close, XCircle
};
