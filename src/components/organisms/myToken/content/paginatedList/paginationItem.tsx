...
import { IconBackground, ItemLeft, ItemRight, ItemWrapper, SupplySymbolTyop, TotalSupplyTypo, SupplyWrapper, TokenInfoNameTypo, TokenInfoSymbolTypo, TokenInfoWrapper, TokenLogoImage, TokenSymbolWrapper, EmptyVerify } from "./style";
...
const PaginatedItem = ({ tokenLogoUrl, tokenSymbol, tokenName, totalSupply, decimals, contractAddress,isVerify = false, onClickItem }: IProps) => {
  ...
  return (
    <ItemWrapper onClick={(event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
