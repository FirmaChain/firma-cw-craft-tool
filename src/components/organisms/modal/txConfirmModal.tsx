...
import { TxCofirmTitleTypoWrapper, TxConfirmWrapper, TxConfirmFailedTypo, TxConfirmModuleTypo, TxConfirmSuccessTypo, TxConfirmTitle, TxConfirmContentTypo, TxConfirmButtonWrapper } from "./style";
