                            ...
                            {headers.map((header, cellIndex) => {
                                ...
                                switch (header) {
                                    case 'Hash':
                                        cell = (
                                            <TableCell key={cellIndex}>
                                                <CellColorTypo color={'#00827A'} onClick={(e: any) => onClickHash(e, item.hash)}>
                                                    {shortenAddress(item.hash, 11, 11)}
                                                </CellColorTypo>
                                            </TableCell>
                                        );
                                        break;
                                    ...
                                    case 'Block':
                                        cell = (
                                            <TableCell key={cellIndex}>
                                                <CellColorTypo color={'#00827A'} onClick={(e: any) => onClickBlock(e, item.height)}>
                                                    {addCommasToNumberString(item.height)}
                                                </CellColorTypo>
                                            </TableCell>
                                        );
                                        break;
                                            ...
                                            cell = (
                                                <TableCell key={cellIndex}>
                                                    <CellWrapper>
                                                        ...
                                                        >
                                                            {shortenAddress(item.address, 8, 10)}
                                                        </CellColorTypo>
