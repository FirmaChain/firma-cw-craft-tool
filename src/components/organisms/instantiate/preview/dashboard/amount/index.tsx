...
import { AmountWrapper, DetailAddressText, DetailLeftWrapper, DetailMinterCapAmount, DetailWrapper, HeaderLeftWrapper, HeaderMinterCapAmount, HeaderMinterCapText, HeaderMinterCapTokenSymbol, HeaderRightWrapper, MinterCapHeaderWrapper, MinterCapWrapper } from "./style";
          ...
          <MinterCapWrapper>
            ...
            {toggleMinterDetail ?
              <DetailWrapper>
                ...
                <DetailMinterCapAmount>{minterCap !== "" ? getUTokenStrFromTokenStr(minterCap, decimals) : "0"}</DetailMinterCapAmount>
              </DetailWrapper>
              : <></>
            }
          </MinterCapWrapper>
